...
const LoginPage = () => {
  // Define currState variable (example: "Login")
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {currState === "Sing up" && !isDataSubmitted && (
            <input  onChange={(e)=>setFullName(e.target.value)} vlaue={fullName} 
          type="text" className='p-2
          border-gray-500 rounded-md focus:outline-none focus:ring-2
          focus:ring-indigo-500' placeholder='Full Name' required/>
        )}
        ...
        {
          currState === "Sing up" && isDataSubmitted && (
            <textarea onChange={(e)=>(setBio(e.target.value))} vlaue={bio} rows={4} className='p-2 border border-gray-500 rounded-md
        ...
        to-violet-600 text-white rounded-md cursor-p=pointer'>
        ...
        <div className='flex flex-col gap-2'>
          {currState === "Sing up" ? (
            ...
            <p className='text-sm text-gray-600'>Create an acount <span 
