    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ""}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
           ...
           <div className='relative py-2 group'>
              ...
              <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md
               bg-[#282142] border border-gray-600 text-fray-100 hidden
                group-hover:block'>
        ...
        py-3 px-4 mt-5'>
          ...
          text-white text-xs placeholder-[#c8c8c8] flex-1' placeholder='Search'/>
        </div>
       ...
       <div className='flex flex-col'>
            {userDummyData.map((user, index)=>(
               ...
               cusor-pointer max-sm:text-sm ${selectedUser?.id === user._id && 
                'bg-[#282142]/50'}`}>
